...
export const metadata: Metadata = {
  title: "Tello - Premium New Cars USA | Best Prices & Selection",
  description: "Find your dream car at Tello. Browse premium new cars in the USA with exceptional service, competitive prices, and easy financing options.",
  keywords: "new cars, car dealership, automotive sales, car buying, premium vehicles USA",
  metadataBase: new URL("https://tello-cars.com"),
  alternates: {
    canonical: "https://tello-cars.com"
  },
  openGraph: {
    title: "Tello - Premium New Cars USA",
    description: "Discover premium new cars with unbeatable prices and exceptional service",
    url: "https://tello-cars.com",
    siteName: "Tello",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35bov8zjOkdGcVDNMecOsQMxHeM/uploaded-1765887352551-6k6drmmy.jpg",
  ...
  twitter: {
    ...
    title: "Tello - Premium New Cars USA",
    description: "Find your dream car with Tello's premium selection and exceptional service",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35bov8zjOkdGcVDNMecOsQMxHeM/uploaded-1765887352551-6k6drmmy.jpg"]
  },
  robots: {
    index: true,
    follow: true
